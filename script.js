...
var marks= document.getElementById('display');
marks.innerText=0;
...
(function() {
    ...
    if (rod === "null" || maxScore === "null") {
        ...
        alert( "Press Enter to start. Use A and D for navigation. Maximum score is " + maxScore * 100);
    }
...
function storeWin(rod, score) {
    ...
    alert( " Your score is " + (score * 100) + ". Max score is: " + (maxScore * 100));
